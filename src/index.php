	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbar1">
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="index.php">Đăng nhập</a></li>
...
<div class="container">
	<div class="row">
		<div class="col-md-4 col-md-offset-4 well">
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="text" name="email" placeholder="test@gmail.com" required class="form-control" />
					</div>
			...
			<!--div class="khung">
				<div class="HaveYet">
				Chưa có tài khoản? <a href="register.php" class="btn btn-primary reg">Đăng ký</a>
				</div>
			</div!-->
		</div>
	</div>
